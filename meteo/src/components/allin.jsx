...
import '../index.css'
function Navbars({ onCityChange }) {
    const [city, setCity] = useState('');
    const [weatherData, setWeatherData] = useState(null);
  
    const getTempo = async () => {
      try {
        const res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&APPID=6456f55a7fc7d2a8b93df59f813b4693`);
        if (res.ok) {
...
<div>
    ...
    <Navbar className="bg-body-tertiary  custom-center">
      <Form inline onSubmit={Submitto}>
        <Row className='dflex'>
          ...
          <Col xs="auto" className='custom-colbutton'>
            <Button type="submit" className='custom-button'><b>Cerca</b></Button>
          </Col>
        </Row>
      </Form>
    </Navbar>
    <div className='custom-city'><h1>-{weatherData?.name}-</h1></div>
    <div className='custom-cn'>
        ...
        <div className='card3' /*! SEZIONE PER LE NUVOLE! */>
        ...
        <div className='card1' /*! SEZIONE PER LA PIOGGIA CHE NON FUNZIONA PERCHE' L'API FA SCHIFO! */>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-rain" viewBox="0 0 16 16">
        ...
        <div className='card3' /*! SEZIONE PER LA TEMPERATURA! */>
